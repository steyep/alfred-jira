  ...
  getTicket: ticket => {
    ...
    return [
      ...
      { title: 'Assigned: ' + assignee, valid: false, icon: './resources/icons/assigned.png', 
        data: {'_key': ticket.Key, currentAssignee: assignee }, 
      ...
      { title: 'Status: ' + status, valid: false, icon: './resources/icons/' + statusIcon + '.png',
        data: { '_key': ticket.Key }, autocomplete: wf._sep + 'status ' + wf._sep + ticket.Key + ' ' + wf._sep},
      { title: 'Add a comment', valid: false, arg:'openURL ' + url, icon: './resources/icons/comment.png',
        data: { '_key': ticket.Key }, autocomplete: wf._sep + 'comment ' + wf._sep + ticket.Key + ' ' + wf._sep },
      watch,
