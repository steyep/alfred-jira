  ...
  getTicket: ticket => {
    ...
    if (progress === false) {
      inProgress = {
        ...
        arg: 'startProgress ' + ticket.Key,
        valid: true,
        icon: 'play.png'
      };
    } else {
      inProgress = {
        title: 'Stop Progress (' + progress + ')',
        arg: 'stopProgress ' + ticket.Key,
        valid: true,
        icon: 'stop.png'
      };
    }
    ...
    return [
      { title: summary, valid: true, arg:'openURL ' + url, icon: 'title.png'},
      { title: description, valid: false, icon: 'description.png'},
      inProgress,
